...
import {Ticket, Tickets, TicketCreate, TicketEdit} from '../types/ticket';
...
import { adaptCategoriesToClient, adaptCommentsToClient, adaptOffersToClient, adaptUserToClient } from '../utils/adapters/adaptersToClient';
import OfferDto from '../dto/offer/offer.dto';
import CommentDto from '../dto/comment/comment.dto';
import UserDto from '../dto/user/user.dto';
import CreateUserWithIdDto from '../dto/user/create-user-wuth-id.dto';
import { adaptAvatarToServer, adaptCreateCommentToServer, adaptCreateTicketToServer, adaptEditTicketToServer, adaptImageToServer, adaptSignupToServer } from '../utils/adapters/adaptersToServer';
